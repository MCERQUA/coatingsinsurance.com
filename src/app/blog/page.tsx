...
export const metadata: Metadata = {
  title: "Coating Contractor Business Insurance Blog",
  description: `Guides on GL, workers comp, completed operations, and surety bonds for coating contractors. Expert advice from ${SITE.name}.`,
};
      ...
      <main>
        <section className="bg-forest-green pt-24 pb-16">
          <div className="container-xl">
            <FadeIn>
              <h1 className="font-heading text-4xl sm:text-5xl text-white font-bold mb-4">Coatings Insurance Blog</h1>
              <p className="font-body text-white/80 text-lg max-w-2xl">
                Expert guides on insurance for wood and steel coating contractors.
              </p>
            </FadeIn>
          </div>
        </section>
