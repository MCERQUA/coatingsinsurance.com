...
import { Shield, HardHat, Wrench, Truck, CheckCircle, FileText, Umbrella, ArrowRight, AlertTriangle, Grid, Home } from "lucide-react";
import { SERVICES } from "@/lib/site";
import { FadeIn } from "@/components/animations/FadeIn";

const ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  Shield, HardHat, Wrench, Truck, CheckCircle, FileText, Umbrella, AlertTriangle, Grid, Home,
};
      ...
      <div className="container-xl">
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl text-bark font-bold mb-4">Coverage for Every Type of Coating Contractor</h2>
            <p className="font-body text-muted max-w-2xl mx-auto">
              GL, CPL, workers comp, and tools & equipment — specialty insurance programs built for painting and coating contractors.
            </p>
          </div>
        </FadeIn>
