          ...
          <div>
            <FadeIn>
              ...
              <h2 className="font-heading text-3xl sm:text-4xl text-bark font-bold mb-4">
                Why Coating Contractors Choose Us
              </h2>
              <p className="font-body text-muted leading-relaxed mb-8">
                We specialize in construction contractor insurance. That means we know coatings insurance, we know the class codes, and we know what GCs require on their subs.
              </p>
            </FadeIn>
